...
def runConversion(filenames, tag_filename, output_filename="logic.txt", CONVERT=False, VIEW_RUNGS=False, COUNT_INSTR=False, PRINT_ERRORS=False):

    for input_filename in filenames:
        system_name = ff.getSystemName(input_filename)
        # system_name = "Sterilizer"
        sys_tag_filename = system_name + "_" + tag_filename
        ...
        tag_file = ff.openFile(sys_tag_filename)

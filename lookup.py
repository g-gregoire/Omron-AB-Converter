...
lookup = {
    ...
    "LD<=(315)": {"instr": "LEQ", "type": "compare", "args": 2, "block_type": "START", "blocks_in": 1},
    "LD=(300)": {"instr": "EQU", "type": "compare", "args": 2, "block_type": "START", "blocks_in": 1},
    "LD>(320)": {"instr": "GRT", "type": "compare", "args": 2, "block_type": "START", "blocks_in": 1},
    "LD>=(325)": {"instr": "GEQ", "type": "compare", "args": 2, "block_type": "START", "blocks_in": 1},
    "OR<=(315)": {"instr": "LEQ", "type": "or_compare", "args": 2, "block_type": "OR", "blocks_in": 1},
    "OR=(300)": {"instr": "EQU", "type": "or_compare", "args": 2, "block_type": "OR", "blocks_in": 1},
    "OR>(320)": {"instr": "GRT", "type": "or_compare", "args": 2, "block_type": "OR", "blocks_in": 1},
    "OR>=(325)": {"instr": "GEQ", "type": "or_compare", "args": 2, "block_type": "OR", "blocks_in": 1},
